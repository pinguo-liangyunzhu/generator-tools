  ...
  module.exports = yeoman.generators.Base.extend({
    ...
    initializing: function () {
      ...
      //dudu
        ...
        this.includeReact      = false;
        this.includeVue        = false;
        this.exitProcess       = false;

        this.includeReflux  = false;
        this.includeRedux  = false;
        this.includeHandlebars = false;
        this.supportECMA6 = false;
        this.includeJqueryAPI = false;

        this.includePgBridge = false;
        this.includeCommonTool = false;
        this.includeImageHandles = false;
    },
